...
public:
        ...
        >& props)
    {
        ...
        static const std::unordered_map<const std::type_info*, buffer_creator_pointer_t> buffer_creator_pointers
        {
            ...
            { &typeid (oil_transport::iso_qsm_pump_parameters), &buffer_builder_t::_create_buffer<
                oil_transport::iso_qsm_pump_parameters, oil_transport::iso_qsm_pump_model_t> },
            { &typeid (oil_transport::iso_qsm_check_valve_parameters), &buffer_builder_t::_create_buffer<
                oil_transport::iso_qsm_check_valve_parameters, oil_transport::iso_qsm_check_valve_model_t> },
            { &typeid (oil_transport::iso_qsm_pump_parameters), &buffer_builder_t::_create_buffer<
                oil_transport::iso_qsm_pump_parameters, oil_transport::iso_qsm_pump_model_t> },
        ...
        std::pair<std::vector<buffer_t>, std::vector<buffer_t>>& buffers)
    {
        ...
        auto make_hydraulic_creator_pointers = []()
        {
            ...
            result[&typeid(oil_transport::qsm_hydro_local_resistance_parameters)] = &model_builder_t::_add_hydro_model<
                oil_transport::qsm_hydro_local_resistance_parameters, oil_transport::qsm_hydro_local_resistance_model_t>;
            result[&typeid(oil_transport::iso_qsm_pump_parameters)] = &model_builder_t::_add_hydro_model<
                oil_transport::iso_qsm_pump_parameters, oil_transport::iso_qsm_pump_model_t>;
            result[&typeid (oil_transport::iso_qsm_check_valve_parameters)] = &model_builder_t::_add_hydro_model<
                oil_transport::iso_qsm_check_valve_parameters, oil_transport::iso_qsm_check_valve_model_t>;
            result[&typeid (oil_transport::iso_qsm_pump_parameters)] = &model_builder_t::_add_hydro_model<
                oil_transport::iso_qsm_pump_parameters, oil_transport::iso_qsm_pump_model_t>;
