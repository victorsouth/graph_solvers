...
private:
    ...
    const std::map<std::string, std::pair<double, double>> units{
        ...
        {"K", {1.0, 0.0}},
        {"kgf/cm2(e)", {1 / TECHNICAL_ATHMOSPERIC_PRESSURE, -ATMOSPHERIC_PRESSURE / TECHNICAL_ATHMOSPERIC_PRESSURE}},
        {"kgf/cm2", {1 / TECHNICAL_ATHMOSPERIC_PRESSURE, -ATMOSPHERIC_PRESSURE / TECHNICAL_ATHMOSPERIC_PRESSURE}},
        {"kgf/cm2(a)", {1 / TECHNICAL_ATHMOSPERIC_PRESSURE, 0.0}},
        {"MPa", {1e-6, 0.0}},
        {"Pa", {1.0, 0.0}},
